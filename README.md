...
围绕 **CS2 饰品价格 / 磨损 / 汰换（Trade Up）** 的工具集合：多平台比价、汰换配方的期望值优化、库存抓取，以及若干独立的 OCR / 目标检测实验脚本（实验性质，未接入主流程）。
...
| **游戏内自动化** | 无 | **激活 CS2 窗口 → 截图 + cv2 模板匹配定位界面元素 → pyautogui 模拟鼠标点击 / 右键 / 滚轮 / 拖拽**，配合 Windows 虚拟桌面隔离运行 |
...
> Required Notice: Copyright (c) 2026 loong-1

| 允许 | 禁止 |
|---|---|
| ✅ 个人学习、技术研究、实验 | ❌ 任何商业用途 |
| ✅ 阅读、克隆、修改源码 | ❌ 出售、出租、按次收费、订阅收费 |
| ✅ 个人兴趣 / 业余项目 | ❌ 集成进商业产品或提供付费服务 |
| ✅ 慈善、教育、公共研究机构使用 | ❌ 营利性的饰品交易、套利、代下单业务 |
| ✅ 分享给他人（须附带本许可全文） | ❌ 去除 Required Notice 或版权声明 |

**非商业目的**（Permitted Purpose）包括：个人研究、实验、为公共知识做测试、
个人学习、私人娱乐、业余爱好，以及慈善组织、教育机构、公共研究机构、
公共安全或卫生组织、环保组织、政府机构的使用。
...
> **注意**：PolyForm Noncommercial 不在 SPDX 标准协议列表中，
> 因此 GitHub 会将其识别为 `NOASSERTION`（自定义协议）而非显示协议徽章。
> 这是预期行为，不影响许可本身的法律效力。
